...
public class CustomerService {
    ...
    public void register(final List<CustomerRequestDTO> customers, Car car) {

         customers.stream().map(prop -> {
            final Driver driver = driverMapper.toEntity(prop.getDriverRequestDTO(), car);
            return mapper.toEntity(prop, driver);
